...
class PdfFile(
    ...
    fun searchNext(text: String) {
        pdfiumCore.search(text)
    }
    ...
    fun searchList(query: String): List<SearchData> {
        println("pdfiumCore.search(query)")
        return pdfiumCore.search(query)
    }
